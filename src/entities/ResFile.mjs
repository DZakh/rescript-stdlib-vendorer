...
import * as LintIssue$RescriptStdlibCli from "./LintIssue.mjs";
import * as LintContext$RescriptStdlibCli from "./LintContext.mjs";
...
function lint(resFile, lintContext, prohibitedModules) {
  resFile.content.split("\n").forEach(function (line, idx) {
        prohibitedModules.forEach(function (moduleName) {
              ...
              if (openRe.test(line)) {
                LintContext$RescriptStdlibCli.addIssue(lintContext, LintIssue$RescriptStdlibCli.make(resFile.path, idx + 1 | 0, {
              ...
              if (usageRe.test(line)) {
                return LintContext$RescriptStdlibCli.addIssue(lintContext, LintIssue$RescriptStdlibCli.make(resFile.path, idx + 1 | 0, {
